...
export const getMerchantEmoji = (merchant: string): string => {
  ...
  return MERCHANT_EMOJI_MAP[cleanMerchant] || '📄';
};
...
export const getSubcategoryEmoji = (subcategory: string): string => {
  ...
  // Find matching subcategory from SUBCATEGORY_KEYWORDS
...
export const getItemDisplayName = (items?: Transaction['items']): string => {
